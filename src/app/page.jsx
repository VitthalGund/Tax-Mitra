            ...
            <div className="container">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                  TaxMitra combines cutting-edge AI with tax expertise to
                  deliver a comprehensive solution for all your tax needs.
                </p>
              </div>
              <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                <Card>
                  ...
                  <CardContent>
                    <CardDescription className="text-base">
                      Our AI analyzes your financial data to identify all
                      possible deductions and credits, ensuring you never pay
                      more than necessary.
                    </CardDescription>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <CardDescription className="text-base">
                      Stay ahead of changing tax laws with real-time
                      notifications about regulatory updates that affect your
                      tax situation.
                    </CardDescription>
                  </CardContent>
                </Card>
              ...
              <div className="grid gap-8 md:grid-cols-3">
                <Card>
                  <CardContent className="pt-6">
                    ...
                    <p className="text-gray-600">
                      "TaxMitra saved my business over ₹75,000 in taxes last
                      year! The AI found deductions my previous accountant
                      missed, and the filing process was incredibly simple."
                    </p>
                ...
                <Card>
                  <CardContent className="pt-6">
                    ...
                    <p className="text-gray-600">
                      "As someone with investments across multiple platforms,
                      tax season used to be a nightmare. TaxMitra consolidated
              ...
              <div className="grid gap-8 md:grid-cols-2">
                ...
                <Card className="overflow-hidden">
                  <div className="bg-teal-800 p-6 text-white">
                    ...
                    <p>
                      Comprehensive tax solutions for companies of all sizes
                    </p>
                  </div>
                  <CardContent className="pt-6">
                    <ul className="space-y-3">
            ...
            <div className="container">
              <div className="text-center max-w-3xl mx-auto">
                ...
                <p className="mt-6 text-sm opacity-80">
                  No credit card required. Free trial includes all features for
                  14 days.
                </p>
              </div>
            </div>
