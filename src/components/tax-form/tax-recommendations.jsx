...
import { AlertCircle, CheckCircle2, Download, FileText, TrendingUp } from "lucide-react"
...
export default function TaxRecommendations({ formData, onClose }: TaxRecommendationsProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between">
        ...
        <div className="space-x-4">
          <Button variant="outline" className="border-[#0f6e6e] text-[#0f6e6e]" onClick={() => onClose()}>
            Save and Close
          </Button>
          <Button className="bg-[#0f6e6e] hover:bg-[#0c5c5c]" onClick={() => onClose()}>
            Complete Tax Filing
          </Button>
        </div>
      </div>
